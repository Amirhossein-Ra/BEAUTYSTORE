  ...
  return (
    <div className="flex justify-evenly m-[10%]">
      ...
      <div className="mr-[50px]">
        <h2 className="text-xl font-semibold mb-4">Active Banner</h2>

        <div className="flex flex-col space-y-4 ">
          <div className="flex items-center justify-between border-b border-b-gray-200 pb-4">
            <img
              src="https://visagetechnologies.com/app/uploads/2023/03/beauty-trends-cover-picture-copy-770x428.webp"
              alt=""
